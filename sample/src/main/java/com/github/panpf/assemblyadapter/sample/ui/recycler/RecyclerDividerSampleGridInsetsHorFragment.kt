...
class RecyclerDividerSampleGridInsetsHorFragment :
    BaseBindingFragment<FragmentDividerSampleGridInsetsHorBinding>() {

    private val appListViewModel by viewModels<AppListViewModel>()

    override fun createViewBinding(
        inflater: LayoutInflater, parent: ViewGroup?
    ): FragmentDividerSampleGridInsetsHorBinding {
        return FragmentDividerSampleGridInsetsHorBinding.inflate(inflater, parent, false)
    }

    override fun onInitViews(
        binding: FragmentDividerSampleGridInsetsHorBinding,
    ...
    override fun onInitData(
        ...
        binding.dividerSampleGridInsetsHorRecycler1.apply {
        ...
        binding.dividerSampleGridInsetsHorRecycler2.apply {
            val recyclerAdapter = AssemblyRecyclerAdapter<Any>(
                listOf(AppGridHorItemFactory(requireActivity()))
            )
            appListViewModel.appListData.observe(viewLifecycleOwner, {
