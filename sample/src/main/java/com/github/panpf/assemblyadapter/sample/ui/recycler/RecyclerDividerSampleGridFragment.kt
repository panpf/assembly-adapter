...
class RecyclerDividerSampleGridFragment :
    ...
    override fun onInitData(
        ...
        val pagerAdapter = ArrayFragmentStateAdapter(
            this,
            listOf(
                RecyclerDividerSampleGridDrawableVerFragment(),
                RecyclerDividerSampleGridDrawableHorFragment(),
                RecyclerDividerSampleGridInsetsVerFragment(),
                RecyclerDividerSampleGridInsetsHorFragment(),
                RecyclerDividerSampleGridSizeVerFragment(),
                RecyclerDividerSampleGridSizeHorFragment(),
            )
        )
