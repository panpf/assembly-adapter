...
class PinyinFlatAppsPagingSource private constructor(
    private val context: Context, private val factory: Factory
) : PagingSource<Int, Any>() {

    class Factory(val context: Context) : Function0<PinyinFlatAppsPagingSource> {

        var pinyinFlatAppsHelper: PinyinFlatAppsHelper? = null

        override fun invoke(): PinyinFlatAppsPagingSource {
            return PinyinFlatAppsPagingSource(context, this)
        }
    }
