...
class RecyclerDividerSampleLinearFragment :
    ...
    override fun onInitData(
        ...
        val pagerAdapter = ArrayFragmentStateAdapter(
            this,
            listOf(
                RecyclerDividerSampleLinearDrawableVerFragment(),
                RecyclerDividerSampleLinearDrawableHorFragment(),
                RecyclerDividerSampleLinearInsetsVerFragment(),
                RecyclerDividerSampleLinearInsetsHorFragment(),
                RecyclerDividerSampleLinearSizeVerFragment(),
                RecyclerDividerSampleLinearSizeHorFragment(),
            )
        )
