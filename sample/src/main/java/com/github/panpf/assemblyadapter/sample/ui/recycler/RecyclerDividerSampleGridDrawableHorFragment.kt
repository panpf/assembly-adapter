...
class RecyclerDividerSampleGridDrawableHorFragment :
    BaseBindingFragment<FragmentDividerSampleGridDrawableHorBinding>() {

    private val appListViewModel by viewModels<AppListViewModel>()

    override fun createViewBinding(
        inflater: LayoutInflater, parent: ViewGroup?
    ): FragmentDividerSampleGridDrawableHorBinding {
        return FragmentDividerSampleGridDrawableHorBinding.inflate(inflater, parent, false)
    }

    override fun onInitViews(
        binding: FragmentDividerSampleGridDrawableHorBinding,
    ...
    override fun onInitData(
        ...
        binding.dividerSampleGridDrawableHorRecycler1.apply {
        ...
        binding.dividerSampleGridDrawableHorRecycler2.apply {
            val recyclerAdapter = AssemblyRecyclerAdapter<Any>(
                listOf(AppGridHorItemFactory(requireActivity()))
            )
            appListViewModel.appListData.observe(viewLifecycleOwner, {
