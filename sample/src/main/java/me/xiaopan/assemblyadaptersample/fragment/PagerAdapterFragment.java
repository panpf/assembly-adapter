...
public class PagerAdapterFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Header header = new Header("我是小额头呀！", "http://www.bz55.com/uploads/allimg/150605/139-150605153433-50.jpg");
        ...
        adapter.addFooterItem(new HeaderPagerItemFactory(), footer);
