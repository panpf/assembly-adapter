...
import me.xiaopan.assemblyadaptersample.itemfactory.HeaderImageFragmentItemFactory;
...
public class ViewPagerFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addHeaderItem(new HeaderImageFragmentItemFactory(), new HeaderImage("我是小额头呀！", "http://img4.imgtn.bdimg.com/it/u=16705507,1328875785&fm=21&gp=0.jpg"));
        adapter.addItemFactory(new ImageFragmentItemFactory());
        adapter.addItemFactory(new TextFragmentItemFactory());
        adapter.addFooterItem(new HeaderImageFragmentItemFactory(), new HeaderImage("我是小尾巴呀！", "http://img2.imgtn.bdimg.com/it/u=4104440447,1888517305&fm=21&gp=0.jpg"));
