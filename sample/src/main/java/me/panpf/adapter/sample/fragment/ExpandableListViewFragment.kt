...
import me.panpf.adapter.expandable.FixedGroupItemInfo
import me.panpf.adapter.expandable.OnGroupLoadMoreListener
...
class ExpandableListViewFragment : Fragment(), OnGroupLoadMoreListener {
    ...
    class LoadTask constructor(val refre: WeakReference<ExpandableListViewFragment>) : AsyncTask<String, String, List<Any>>() {
        ...
        override fun onPostExecute(objects: List<Any>) {
            refre.get()?.run {
                ...
                if (adapter == null) {
                    ...
                    adapter!!.setLoadMoreItem(LoadMoreGroupItemFactory(this))
