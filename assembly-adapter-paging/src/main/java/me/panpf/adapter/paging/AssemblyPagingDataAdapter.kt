package me.panpf.adapter.paging
...
import me.panpf.adapter.paged.BasePagingAssemblyRecyclerAdapter
...
class AssemblyPagingDataAdapter<T> @JvmOverloads constructor(
    ...
    init {
        ...
        fun considerAllowingStateRestoration() {
            if (stateRestorationPolicy == StateRestorationPolicy.PREVENT && !userSetRestorationPolicy) {
                this@AssemblyPagingDataAdapter.stateRestorationPolicy =
     ...
     *
     * [AssemblyPagingDataAdapter]'s async diffing means that efficient change animations are handled for
     * you, without the performance drawbacks of [RecyclerView.Adapter.notifyDataSetChanged].
     * Instead, the diffCallback parameter of the [AssemblyPagingDataAdapter] serves the same
    ...
    /**
     * Stable ids are unsupported by [AssemblyPagingDataAdapter]. Calling this method is an error and will
    ...
    /**
     * Refresh the data presented by this [AssemblyPagingDataAdapter].
     *
