...
class ChildLongClickListenerWrapperTest {
    ...
    fun test() {
        ...
        val childClickListener =
            OnChildLongClickListener<TextGroup, String> { _, _,
        ...
        ChildLongClickListenerWrapper(childClickListener).onLongClick(itemView)
