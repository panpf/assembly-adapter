...
abstract class SimpleChildItemFactory<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any>(
    dataClass: KClass<CHILD_DATA>
) : ChildItemFactory<GROUP_DATA, CHILD_DATA>(dataClass) {
    ...
    private class SimpleChildItem<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any>(
        private val factory: SimpleChildItemFactory<GROUP_DATA, CHILD_DATA>, itemView: View
    ) : ChildItemFactory.ChildItem<GROUP_DATA, CHILD_DATA>(itemView) {
