...
/**
 * It is not recommended to directly inherit [ChildItemFactory],
 * you can inherit [BindingChildItemFactory] and [SimpleChildItemFactory] to implement your own ItemFactory
 *
 * @see BindingChildItemFactory
 * @see SimpleChildItemFactory
 * @see ViewChildItemFactory
 */
abstract class ChildItemFactory<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any>(dataClass: KClass<CHILD_DATA>) :
    ItemFactory<CHILD_DATA>(dataClass) {

    abstract override fun createItem(parent: ViewGroup): ChildItem<GROUP_DATA, CHILD_DATA>

    abstract class ChildItem<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any> :
        Item<CHILD_DATA> {
