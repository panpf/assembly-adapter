...
abstract class BindingChildItemFactory<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any, VIEW_BINDING : ViewBinding>(
    ...
    private class BindingChildItem<GROUP_DATA : ExpandableGroup, CHILD_DATA : Any, VIEW_BINDING : ViewBinding>(
        private val factory: BindingChildItemFactory<GROUP_DATA, CHILD_DATA, VIEW_BINDING>,
