 ...
 */
package com.github.panpf.assemblyadapter.pager.concat.fragment

import android.database.DataSetObserver
import androidx.fragment.app.FragmentPagerAdapter

/**
 * Wrapper for each adapter in [ConcatFragmentPagerAdapter].
 */
internal class NestedFragmentPagerAdapterWrapper(
    val adapter: FragmentPagerAdapter,
    private val mCallback: Callback,
    private val mStableIdLookup: FragmentPagerStableIdStorage.StableIdLookup
) {
    /**
    ...
    private val mAdapterObserver: DataSetObserver = object : DataSetObserver() {
        override fun onChanged() {
            ...
            mCallback.onChanged(this@NestedFragmentPagerAdapterWrapper)
        }
    }
    ...
    internal interface Callback {
        fun onChanged(wrapper: NestedFragmentPagerAdapterWrapper)
    }
}